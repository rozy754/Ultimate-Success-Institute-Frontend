      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Empowering students and professionals with quality education, comprehensive resources, and personalized
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Button variant="outline" size="sm" asChild className="mt-2 bg-transparent">
                  <a
                    href="https://wa.me/919876543210?text=Hello! I'm interested in learning more about Ultimate Success Institute."
                    target="_blank"
        ...
        <div className="border-t border-border mt-12 pt-8 text-center">
          <p className="text-muted-foreground text-sm">
            © 2024 Ultimate Success Institute. All rights reserved. |
